      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='mb-6'>
         ...
         <div className='mb-6'>
          ...
          <input type='text' name='number' value={productData.sizes.join(", ")}
        ...
        <button type="submit" className='w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 transition-colors text-center'>
  Update Product
</button>
