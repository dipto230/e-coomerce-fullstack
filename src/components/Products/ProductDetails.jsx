...
const allProducts = [
  ...
  },
  {
    ...
    price: 90,
    originalPrice: 110,
    description: "A cool denim jacket for casual days",
    brand: "UrbanStyle",
    material: "Denim",
    sizes: ["M", "L"],
    colors: ["Blue", "Black"],
    images: [
      { url: "https://picsum.photos/500/500?random=10", altText: "Denim Front" },
      { url: "https://picsum.photos/500/500?random=11", altText: "Denim Back" },
    ],
  },
    {
    _id: "3",
...
const ProductDetails = () => {
  ...
  if (!selectedProduct) {
    return <div className='p-6 text-center text-red-500 text-xl'>Product not found</div>;
  }
      ...
      <div className='max-w-6xl mx-auto bg-white p-8 rounded-lg'>
        <div className='flex flex-col md:flex-row'>
          ...
          <div className='hidden md:flex flex-col space-y-4 mr-6'>
            {selectedProduct.images.map((image, index) => (
              <img
                ...
                className={`w-20 h-20 object-cover rounded-lg cursor-pointer ${mainImage === image.url ? "border-2 border-black" : "border border-gray-300"}`}
          ...
          <div className='md:w-1/2 md:ml-10'>
            ...
            <p className='text-lg text-gray-800 mb-1 line-through'>${selectedProduct.originalPrice}</p>
